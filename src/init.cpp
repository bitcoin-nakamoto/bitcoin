...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    if (showDebug)
        strUsage += HelpMessageOpt("-blockmaxsize=<n>", "Set maximum BIP141 block weight to this.");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoin-nakamoto/bitcoin>";
    const std::string URL_WEBSITE = "<https://bitcoinnakamoto.org>";
...
bool AppInitMain()
{
    ...
    strSubVersion = GetSubVersionEB(DEFAULT_MAX_BLOCK_SIZE);
