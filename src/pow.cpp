...
// Entire GetNextEDAWorkRequired function was Copied from Bitcoin-ABC
/**
 ...
 */
static uint32_t GetNextEDAWorkRequired(const CBlockIndex *pindexPrev, const CBlockHeader *pblock) {
...
uint32_t GetNextWorkRequired(const CBlockIndex *pindexPrev, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    if (IsDAAEnabled(pindexPrev))
        return GetNextCashWorkRequired(pindexPrev, pblock);

    return GetNextEDAWorkRequired(pindexPrev, pblock);
}
...
// Entire ComputeTarget function was Copied from Bitcoin-ABC
/**
...
// Entire GetSuitableBlock function was Copied from Bitcoin-ABC
/**
...
// Entire GetNextCashWorkRequired function was Copied from Bitcoin-ABC
/**
