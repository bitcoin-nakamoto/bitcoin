...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Bitcoin copyright is not removed by accident
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Bitcoin") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Bitcoin developers";
    }
